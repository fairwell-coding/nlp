python ./transformers-main/examples/research_projects/seq2seq-distillation/distillation.py --teacher google/mt5-small --data_dir data/cmu_hinglish_dog_distillation \
